...
var Tabs = React10.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [displayScroll, setDisplayScroll] = React10.useState({
    start: false,
    end: false
  });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime10.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime10.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const handleTabsScroll = React10.useMemo(() => debounce_default(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React10.useEffect(() => {
    return () => {
  ...
  const indicator = (0, import_jsx_runtime10.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime11.jsxs)(TabsRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref,
    as: component
...
//# sourceMappingURL=chunk-CW5JJNO7.js.map
